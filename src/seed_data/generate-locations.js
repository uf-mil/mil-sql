...
// Run with: node generate-locations.js
// Output: src/seed_data/inventory-locations.json
...
// Write to file
const outputPath = path.join(__dirname, 'inventory-locations.json');
